...
#
# set dispersions of the two random variables and correlation coefficient between them
#
s1 = 1.0; s2 = 1.0; r12=0.6
#
# set parameters of the chain
#
n = 100000; nburn=3000; nsel=10; step = 1.0
x = -1.0; y = -1.0
chain = []
chain.append([x,y])
...
#
# remove nburn initial entries and select every nsel-th entry after that
#
